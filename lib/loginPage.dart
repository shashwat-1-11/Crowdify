...
import 'package:textify/utils/components.dart';
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      TextField(
                        ...
                        decoration: customBoxStyle.copyWith(
                          suffixIcon: IconButton(
                            ...
                            onPressed: (){
                                setState(() {
                                  loginObscure = loginObscure == true ? false : true;
                                });
                            },
                          ),
                        ),
                      ...
                      Container(
                        ...
                        child: Text('Forgot Password?', style: TextStyle(fontSize: 15.0, fontWeight: FontWeight.bold)),
                      ),
